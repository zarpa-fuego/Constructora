        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="col-span-1 grid grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" value="250" class="w-full border rounded-lg px-4 py-2" readonly>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Precio Base</label>
                    <input type="text" value="$45,000.00" class="w-full border rounded-lg px-4 py-2" readonly>
                </div>
            </div>
